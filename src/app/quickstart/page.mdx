...
import stepupImage from '@/images/stepup.png'
...
Great, you're now set up with an verified merchant account and have made your first app. Here are a few links that might be handy as you venture further into ourapp.studio:
