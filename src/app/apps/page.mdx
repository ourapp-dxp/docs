export const metadata = {
  title: 'Apps',
  description:
    'On this page, we’ll dive into the different configuration options for creating an app instance.',
}

# Apps

'Apps' allow you to create interconnected journeys for your users, using a variety of assets owned by your ourapp organization.
On this page, we'll dive into the different configuration options you can set in your app. We'll look at how to setup your app for your first sale, add a product menu, a business form and even interconnect seperate apps under the same organization - to create a rich app experience.{{ className: 'lead' }}
